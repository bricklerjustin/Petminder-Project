...
namespace PetminderApp.Encryption
{
    class EncriptDecription
    {
        // A method used to Encrypt a plain text. 
        ...
        // A method used to convert an Encripted text to a plain text. 
